...
export const ScStackConsoleApis = (data: ScStackConsoleApisProps) => {
  ...
  return (
    <section
      className="relative overflow-hidden bg-dark w-full px-4 py-12 -mb-12 bg-dark"
    ...
    >
      <div className="section-inner max-w-7xl mx-auto md:px-4 md:py-10">
        <h2 className="text-4xl md:text-6xl font-semibold text-left md:text-center  text-white  px-4 mb-6">
          <span className="highlightedText pr-2">
            {data.headingHighlighted}
          </span>
          {data.heading}
        </h2>
        <p className="text-white text-left md:text-center px-4 md:px-10 lg:text-sm">{data.description}</p>
        {/* Add more content as needed */}
        <div className="mt-10 flex justify-center md:px-16 lg:px-42">
          <Image

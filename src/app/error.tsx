      ...
      <div className="mx-auto w-full max-w-xl px-6">
        ...
        >
          ...
          <div className="mt-6 flex gap-3">
            <button
              onClick={reset}
              className="rounded-md bg-white px-4 py-2.5 text-sm font-semibold text-gray-900 hover:opacity-90"
            >
              Try again
            </button>
            <Link
              href="/"
              className="rounded-md border border-white/60 px-4 py-2.5 text-sm font-semibold text-white/95 hover:bg-white/10"
            >
              Go home
            </Link>
          </div>
